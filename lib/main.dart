...
class CounterStateInValid extends CounterState {
  ...
  const CounterStateInValid(
      {required this.invalidValue, required this.previousVal})
      : super(previousVal);
}
...
class IncrementEvent extends CounterEvent {
  const IncrementEvent(super.val);
}

class DecrementEvent extends CounterEvent {
  const DecrementEvent(super.val);
}
    ...
    on<IncrementEvent>((event, emit) {
      ...
      if (integer == null) {
        emit(CounterStateInValid(
            invalidValue: event.value, previousVal: state.val));
      } else {
